...
public class Log{
	...
	//导入数据记录日志 importDataLog
	public static Logger importDataLog = LogFactory.getServiceLog(Constants.APP_NAME + "_importData");

	//导入数据记录日志 importDataLog
	public static Logger requestPingGaoLog = LogFactory.getServiceLog(Constants.APP_NAME + "_requestPingGao");
	...
	public static Logger nvnTaskLog = LogFactory.getServiceLog("nvnTask");
}
