 ...
 * @author gaosong
 */
public class FaceArchivesEsModel {
	...
	/**数据来源[-1:其他 0:自建 1:火车 2:民航 3:汽车 4:住宿 5:网吧 6:出入境 7:涉警]**/
	...
	public FaceArchivesEsModel() {
	}	
	
	public FaceArchivesEsModel(long infoId, long personId, String pic,  byte dataSource,String creator) {
		this.infoId = infoId;
		...
		String faceFeature = featureResp.getRltz();
		
		this.rltz =faceFeature;
		this.picQuality =featureResp.getScore();
	}
		

	public FaceArchivesEsModel(long infoId, long personId, String pic, int picQuality, byte dataSource,
			String creator, String rltz) {
		super();
		this.infoId = infoId;
		this.personId = personId;
		this.pic = pic;
	...
	public Map<String,Object> toESMap(){
		...
		map.put("SEX", sex);
		map.put("PERSON_TAG", personTag);	
		map.put("RLTZ", rltz);
		return map;	
	}
	
	/**应用参数构造专题库es实体**/
	public static FaceArchivesEsModel paramsToModel(Map<String,Object> params){
		FaceArchivesEsModel model = new FaceArchivesEsModel();
