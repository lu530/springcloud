		...
		if(initQueryParams()){
			...
			/*if(isOpenSearchCause()){*/
				searchBeforeLogged(function(){
					...
					showForm('/efacecloud/page/technicalStation/libraryTrajectory.html');
...
function addSelectChangeListener (selector) {
	
	$("body").on("change",selector,function () {
		console.log("123");
		if($(this).val()){
			$(this).parents("fieldset").children(".crossing").removeClass("hide");
		}
		else{
			$(this).parents("fieldset").children(".crossing").addClass("hide");
		}
