...
Raphael = (function () {
    ...
    var separator = /[, ]+/,
        ...
        availableAttrs = {blur: 0, "clip-rect": "0 0 1e9 1e9", cursor: "default", cx: 0, cy: 0, fill: "#fff", "fill-opacity": 1, font: '10px "Arial"', "font-family": '"Arial"', "font-size": "10", "font-style": "normal", "font-weight": 100, gradient: 0, height: 0, href: "http://raphaeljs.com/", opacity: 1, path: "M0,0", r: 0, rotation: 0, rx: 0, ry: 0, scale: "1 1", src: "", stroke: "#000", "stroke-dasharray": "", "stroke-linecap": "butt", "stroke-linejoin": "butt", "stroke-miterlimit": 0, "stroke-opacity": 1, "stroke-width": 1, target: "_blank", "text-anchor": "middle", title: "Raphael", translation: "0 0", width: 0, x: 0, y: 0},
    ...
    if (R.svg) {
        ...
        var setFillAndStroke = function (o, params) {
            if(params.text) params["stroke-width"] = "1px";//xc mark：是文字的统一给 stroke-width=1
        ...
        var theCircle = function (svg, x, y, r) {
            ...
            res.attrs = {cx: x, cy: y, r: r, fill: "transparent", stroke: "#000"};
            res.type = "circle";
            $(el, res.attrs);
            return res;
        };
        var theRect = function (svg, x, y, w, h, r) {
            ...
            svg.canvas && svg.canvas[appendChild](el);
            var res = new Element(el, svg);
            res.attrs = {x: x, y: y, width: w, height: h, r: r || 0, rx: r || 0, ry: r || 0, fill: "transparent", stroke: "#000"};
            res.type = "rect";
            $(el, res.attrs);
            return res;
        };
        var theEllipse = function (svg, x, y, rx, ry) {
            ...
            svg.canvas && svg.canvas[appendChild](el);
            var res = new Element(el, svg);
            res.attrs = {cx: x, cy: y, rx: rx, ry: ry, fill: "transparent", stroke: "#000"};
            res.type = "ellipse";
            $(el, res.attrs);
            return res;
        };
        ...
        var theText = function (svg, x, y, text) {
            ...
            svg.canvas && svg.canvas[appendChild](el);
            var res = new Element(el, svg);
            res.attrs = {x: x, y: y, "text-anchor": "middle", text: text, font: availableAttrs.font, stroke: "none", fill: "#000", "font-weight": availableAttrs["font-weight"]};
            res.type = "text";
    ...
    if (R.vml) {
        ...
        theText = function (vml, x, y, text) {
            ...
            res.attrs.w = 1;
            res.attrs.h = 1;
            setFillAndStroke(res, {font: availableAttrs.font, stroke: "none", fill: "#000", "font-weight": availableAttrs["font-weight"], "stroke-width": 1});
            res.setBox();
            vml.canvas[appendChild](g);
            return res;
        };
