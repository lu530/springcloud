...
Mock.mock('/user/sysUser/getLoginUser', {
    'list1|1-10': [{
...
//城市住址
Mock.mock(/dataCity\/rest\/area$/, {
	/*'areaList':{*/
		'records': {
			'provinceArea':[{
	    		'name':'广东省',
	    		'id':'gds','ORG_CODE':'province'
	    	},{
	    		'name':'广西省',
	    		'id':'gxs','ORG_CODE':'province'
	    	},{
	    		'name':'江西省',
	    		'id':'jxs','ORG_CODE':'province'
	    	},{
	    		'name':'贵州省',
	    		'id':'gzs','ORG_CODE':'province'
	    	}],
	    	'cityArea':[{
	    		'name':'广州市',
	    		'id':'gzs','ORG_CODE':'city'
	    	},{
	    		'name':'深圳市',
	    		'id':'sz','ORG_CODE':'city'
	    	},{
	    	...
	    	'districtCounty':[{'name':'荔湾区','id':'lw','ORG_CODE':'district'},
	    	                  {'name':'越秀区','id':'yx','ORG_CODE':'district'},
	    	                  {'name':'海珠区','id':'hj','ORG_CODE':'district'},
	    	                  {'name':'天河区','id':'th','ORG_CODE':'district'},
	    	                  {'name':'白云区','id':'by','ORG_CODE':'district'},
	    	                  {'name':'黄浦区','id':'hp','ORG_CODE':'district'},
	    	                  {'name':'番禺区','id':'py','ORG_CODE':'district'},
	    	                  {'name':'花都区','id':'hd','ORG_CODE':'district'},
	    	                  {'name':'南沙区','id':'ns','ORG_CODE':'district'},
	    	                  {'name':'萝岗区','id':'lg','ORG_CODE':'district'},
	    	                  {'name':'增城区','id':'zc','ORG_CODE':'district'},
	    	                  {'name':'从化区','id':'ch','ORG_CODE':'district'}]
	    }
	/*}*/
});

//行政树
Mock.mock('/datadefence/rest/dept', {

});

//卡口树
Mock.mock(/efacecloud\/rest\/bayonet$/, 
		{'structureTree':[{
    "ChildNodes": [
        {
            "ChildNodes": [
