...
//布控任务管理页面的数据 controlPerson/task/getData
Mock.mock(/controlPerson\/task\/getData$/, {
	'dispatchedLibList':{
		'count':100,
	    'records|100': [{
	    	'COMMUNITY_ID|+1':1000,
	    	...
	    	'rowid|+1':1,
	    	'_index|+1':0,
	        'COMMUNITY_NAME|1':['家','学校','公司','地铁','公交局','公安局'],
	        'TASK_NAME|1':['监控','收集证据','分析案情','监督'],
	        'CREATOR|1':['老板','管理员','系统管理员','普通用户','超级用户'],
	        'CREATE_TIME':'@date',
	        'STATUS_CODE|1':['未布控','布控中','已布控','撤控'],
	        'OPT_STATUS|1':[70,80],
	        'DB_NAME_LOCAL':1,
	        'rowid':1
	    }]
...
//关联警务通   efacecloud/localOtherPoliceTerminal/getData
Mock.mock(/efacecloud\/localOtherPoliceTerminal\/getData$/, {
	'policeTerminalList':{
		'count':3,
	    'records|100': [{
	    	'CREATEDTIME':'@date',
	    	'NAME|1':[055684,468446,138464],
	    	'NODE_NAME|1':['天河区','白云区','海珠区'],
	    	'OBJ_ID|+1':10,
	    	'ORG_CODE|1':[055684,468446,138464],
	    	'PASSWORD':123456,
	    	'USERNAME':'@cname',
	    	'ZDIMEI':'',
	    	'ZRRJH|1':[055684,468446,138464],
	    	'rowid':1
	    }]
	}
});
...
//布控库管理   controlPerson/lib/getData
Mock.mock(/controlPerson\/lib\/getData$/,{
	'storeList':{
		'count':100,
	    'records|100':[{
		'NODE_NAME|1':['广东省','广西省','云南省'],
		'ORG_CODE|+1':1,
		'OwnerType|1':['1','2'],
		'PassNum':0,
		'STATUS_CODE|1':[0,1],
		'SYNC_STATUS|1':['0','1'],
		'SrcStoreID':'',
		'StoreID':"e84b4226f83e419292360f10a64189d0",
		'StoreName|1':['广东布控','北京布控','上海布控'],
		'StoreNum':2,
		'StoreTime':'@date',
		'StoreType':[0,1],
		'UserCode':"admin",
...
//布控库管理 地址树  user/org/getTree
Mock.mock(/user\/org\/getTree$/,[{
		"ChildNodes": [
        {
            "ChildNodes": [
                {
...
//审批管理 controlPerson/object/getData/approvalManage
Mock.mock(/controlPerson\/object\/getData\/approvalManage$/,{
...
//布控库管理 =》管理 controlPerson/object/getData/synchronizedCheckInfo
Mock.mock(/controlPerson\/object\/getData\/synchronizedCheckInfo$/,{
	"dispatchedApprovalList":{
		'count':100,
	    'records|100':[{
		'CONTROL_TIME':"@date",
...
//撤控   controlPerson/object/getData/removeControl
Mock.mock(/controlPerson\/object\/getData\/removeControl$/,{
	"dispatchedApprovalList":{
		'count':100,
	    'records|100':[{
		'CONTROL_TIME':"@date",
...
//布控任务管理修改  efacecloud/localCommunityTerminal/getData
Mock.mock(/efacecloud\/localCommunityTerminal\/getData$/, {
	'localCommunityTerminalList':{
		'count':10,
	    'records|10': [{
	    	'CREATEDTIME':'@date',
	    	'NAME':[055684,468446,138464],
	    	'NODE_NAME|1':['天河区','白云区','海珠区'],
	    	'OBJ_ID|1':[055684,468446,138464],
	    	'ORG_CODE|1':[055684,468446,138464],
	    	'PASSWORD':123456,
	    	'USERNAME':'@cname',
	    	'ZDIMEI':'',
...
//布控任务管理修改=》场景选择   person/control/community/list
Mock.mock(/person\/control\/community\/list$/, {
	'dispatchedLibList':{
		'1':'佳都科技',
		'2':'站前路21号',
		'3':'test',
...
//   person/control/getPersonAlarmThresold
Mock.mock(/person\/control\/getPersonAlarmThresold$/, {
	'dispatchedLibList':{
		'count':3,
	    'records|3': [{
	    	'thresold|+1':1
...
//addExecuteControl.js 申请的数据  person/control/lib/localall
Mock.mock(/person\/control\/lib\/localall$/, {
	'proList|10':[{
	    	'SID|+1':1,
	    	'TITLE|1':["52f66fd01b474e9a9de290c2791d663b","72beec690020470788f427bf9b833f1f","d00795bebac74769a21b82a525ea2444"],
	    	'VALUE':'@cname'
	    }]
});

// person/control/lib/syncall
Mock.mock(/person\/control\/lib\/syncall$/, {
	'dispatchedLibList':{
		'count':3,
	    'records': [],
	}
...
// person/control/lib/sync
Mock.mock(/person\/control\/lib\/sync$/, {
	'proList':[{
		'TITLE':"72beec690020470788f427bf9b833f1f",
		'VALUE':"555"
    }]
});

// person/control/lib/local
Mock.mock(/person\/control\/lib\/local$/, {
	'proList':[{
		'TITLE':"72beec690020470788f427bf9b833f1f",
		'VALUE':"林芳"
    }]
...
Mock.mock(/person\/control\/updateTask$/, {
	message: "布控任务更新成功！", status: true
});

Mock.mock(/person\/control\/deleteTask$/, {
	message: "删除布控任务成功！", status: true
});


//布控库管理页面 添加库
Mock.mock(/person\/control\/addLib$/, {
	message: "操作成功！", status: true
});

//布控库管理页面 删除库
Mock.mock(/person\/control\/deleteLib$/, {
	message: "操作成功！", status: true
});

//人像维护    person/control/getPersonDetail
Mock.mock(/person\/control\/getPersonDetail$/, {
	result:{
		'CarList':[],
		'Comment':"续控",
		'ControlReason':"抢劫运钞车",
		...
		'EndBeinTime':'@date',
		'FaceImgList':[],
		'IDCard':411524197803250685,
		'MainFaceImgID':"@imgPersonPhoto(20)",
		'Monitor':"系统管理员",
		'MonitorDept':"组织架构",
		'PersonName':'@cname',
		'PersonSex':1,
		...
		'STATUS_CODE':0,
		'Status':0,
		'StoreId':"d0601d4a65ab46e08bb4aa845cd452a7",
		'UserCode':"admin"
	}
});
...
//布控库管理页面 添加库 =》 添加人
Mock.mock(/person\/control\/addPerson$/, {
	status: true
});

Mock.mock(/person\/control\/containPersonCode$/, {
	jsonData: {"IDCard":"444444444444444444","PersonName":"xxx","Status":0,"Comment":"","requestFrom":"web"}
});

Mock.mock(/person\/control\/updateApprove$/, {
	status: true
});

//撤销布控
Mock.mock(/person\/control\/removePerson$/, {
	status: true
});

//续控
Mock.mock(/person\/control\/reStationing$/, {
	status: true
});
